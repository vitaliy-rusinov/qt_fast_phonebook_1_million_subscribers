...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_lists_t, stringdata) + ofs \
...
void lists::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        lists *_t = static_cast<lists *>(_o);
        switch (_id) {
        case 0: _t->on_cmd_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject lists::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_lists.data,
      qt_meta_data_lists,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_lists.stringdata))
        return static_cast<void*>(const_cast< lists*>(this));
